      ...
      <main className="pt-24 pb-16 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-gray max-w-none space-y-6" style={{ color: '#4A4A4A' }}>
            ...
            <p>
              All content purchased from DiploMate is for personal educational use only.
            ...
            <p>
              All sales are final. Due to the digital nature of our products, refunds are generally
              not available.
            </p>
            ...
            <p>
              Each purchase comes with a limited number of downloads. These limits are in place for
              content security.
            </p>
