  ...
  const steps = [
    {
      ...
      description:
        'Explore our collection of notes, microprojects, and capstone projects. Use filters to find exactly what you need by department, semester, and scheme.',
      stepLabel: 'Step 1',
    ...
    },
    {
      ...
      title: 'Add to Cart',
      description:
        'Click "Buy Now" on any resource. Review the details, price, and what\'s included before proceeding to checkout.',
      stepLabel: 'Step 2',
    ...
    },
    {
      ...
      description:
        'Choose your payment method (UPI, Cards, Net Banking, Wallets). Enter details and confirm payment securely.',
      stepLabel: 'Step 3',
    ...
    },
    {
      ...
      description:
        'Get immediate access to download links via email and your account dashboard. Download anytime, anywhere!',
      stepLabel: 'Step 4',
      ...
      <div className="bg-gradient-to-r from-blue-500 to-teal-400 pt-32 pb-20 text-white text-center px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10">
            Simple 4-step process to get your study materials instantly
          </p>
        ...
        <div className="space-y-6 mb-16">
          {steps.map((step) => {
            ...
            return (
              <div
                key={step.id}
                className="bg-white rounded-2xl p-8 shadow-sm border border-slate-100 flex flex-col md:flex-row items-start md:items-center gap-6 hover:shadow-md transition-shadow"
              >
                <div className="flex flex-col items-center gap-2 min-w-[80px]">
                  <div
                    className={`w-16 h-16 rounded-2xl ${step.iconBg} flex items-center justify-center`}
                  >
