...
const ProjectsPage = lazy(() => import('@/pages/ProjectsPage').then(module => ({ default: module.default || module.ProjectsPage }))); // Handle default or named export
...
const HowToBuy = lazy(() => import('@/pages/HowToBuy').then(module => ({ default: module.HowToBuy })));
const PaymentHelp = lazy(() => import('@/pages/PaymentHelp').then(module => ({ default: module.PaymentHelp })));
...
const AdminSubjects = lazy(() => import('@/pages/admin/AdminSubjects').then(module => ({ default: module.AdminSubjects })));
...
export const routes: RouteObject[] = [
  ...
  { path: '/microprojects', element: <ProjectsPage /> },
  { path: '/capstone-projects', element: <ProjectsPage /> },
  { path: '/custom-build', element: <ProjectsPage /> },
